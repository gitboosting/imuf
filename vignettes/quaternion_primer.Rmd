...
Quaternion algebra is similar to complex number algebra, but with the added complications of quaternions having four components and the quaternion units needing to obey a more extensive set of rules as stated above.
...
One can rotate a vector quaternion $q_{u}$ by a rotation quaternion $q$ using the following transformation:
