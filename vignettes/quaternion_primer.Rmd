...
Now that we are familiar with the basic characteristics of quaternions and their relations to 3-vectors and rotations in 3D, let's delve into some quaternion operations that are relevant in sensor fusion.

### Finding a rotation that rotates one vector into another
