...
We first use the [serial package](https://cran.r-project.org/web/packages/serial/index.html) to set up a serial port connection. We then enter into a loop to check if there is data and if so, whether it meets certain requirements.
