...
#' situated on the shin of subject 1 while the subject was walking for 10 minutes
#'
...
#' }
#' @source <https://www.uni-mannheim.de/dws/research/projects/activity-recognition/dataset/dataset-realworld/s1/>
"walking_shin_1"
